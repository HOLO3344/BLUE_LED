...
#define SIMPLEPROFILE_CHAR7                   6  // RW uint8 - Profile Characteristic 6 value
#define SIMPLEPROFILE_CHAR8                   7  // RW uint8 - Profile Characteristic 6 value
#define SIMPLEPROFILE_CHAR9                   8  // RW uint8 - Profile Characteristic 6 value
...
#define SIMPLEPROFILE_CHAR6_LEN           10     // ¿ØÖÆ×Ö½Ú
#define SIMPLEPROFILE_CHAR7_LEN           2     //  
#define SIMPLEPROFILE_CHAR8_LEN           18     //  
#define SIMPLEPROFILE_CHAR9_LEN           13     //  
