...
#define SERVAPP_NUM_ATTR_SUPPORTED        29//20//17
...
static uint8 simpleProfileChar6UserDesp[] = "CNT_SET\0";
...
static uint8 simpleProfileChar7UserDesp[] = "INMODEL SET\0";
...
static uint8 simpleProfileChar8UserDesp[] = "COLOUR SET\0";
...
static uint8 simpleProfileChar9UserDesp[] = "CIRCL SET\0";
...
bStatus_t SimpleProfile_SetParameter( uint8 param, uint8 len, void *value )
{
  ...
  switch ( param )
  {
    ...
    case SIMPLEPROFILE_CHAR8:
      ...
      {
        VOID osal_memcpy( simpleProfileChar6, value, SIMPLEPROFILE_CHAR9_LEN );
      }
      else
      {
        ret = bleInvalidRange;
